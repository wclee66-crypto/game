 ...
 * {
 *   v: 1,
 *   settings: { fontScale:'md'|'lg'|'xl', sound:true, lang:'ko'|'en', introDone:false, cursor:'md'|'lg' },
...
window.Store = (function () {
  ...
  function blank() {
    return {
      v: 1,
      settings: { fontScale: 'md', sound: true, lang: null, introDone: false, cursor: 'lg' },   /* lang 이 null 이면 브라우저 말을 따른다 · cursor 는 마우스 화살표 크기 */
      records: {},
